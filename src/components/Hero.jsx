export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen bg-[#0A2A66] flex items-center pt-16"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          {/* Left: Text */}
          <div>
            <p className="text-[#22C55E] font-semibold text-sm tracking-widest uppercase mb-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 bg-[#22C55E] hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors shadow-lg"
              >
              ...
              <a
                href="#services"
                className="flex items-center justify-center gap-2 border border-white text-white hover:bg-white hover:text-[#0A2A66] font-semibold px-6 py-3 rounded-lg transition-colors"
              >
                View Services
              </a>
            </div>
            ...
            <div className="relative w-full max-w-lg">
              <div className="bg-white/10 border border-white/20 rounded-2xl p-6 backdrop-blur-sm">
                <img
                  ...
                  className="rounded-xl w-full object-cover h-72 shadow-2xl"
                />
                {/* Service badges overlaid */}
